...
class MusicAppDiscovery(val context: Context, val handler: Handler): CoroutineScope {
	...
	private fun probeApp(appInfo: MusicAppInfo) {
		...
		val controller = CombinedMusicAppController(handler, connectors, appInfo)
